...
URL | dosyaismi.mp4"""
    ...
    lis = [InlineKeyboardButton('Yardım', callback_data='help')]
    if Config.UPDATE_CHANNEL: lis.append(InlineKeyboardButton('Kanal', url=f"https://t.me/{Config.UPDATE_CHANNEL}"))
    ...
    HELP_TEXT = f"""Nasıl kullanılırım? Aşağıdaki adımları izleyin!
    
1. URL gönderin.
2. Kapak fotoğrafı için fotoğraf gönderin. (İsteğe bağlı)
3. Buton seçin.
Bot cevap vermediyse {Config.CONTACT} ile iletişime geçin"""
